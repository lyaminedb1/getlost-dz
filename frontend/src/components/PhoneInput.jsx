 ...
 */
export default function PhoneInput({ value = '', onChange, dark = false, style = {}, placeholder = '0770 123 456' }) {
  ...
  const baseBorder = dark ? '1.5px solid rgba(255,255,255,.25)' : '1.5px solid #E2EBF0'
